...
{
 if (g_getenv ("PLUMA_DEBUG") != ((void*)0))
 {
 ...
 if (g_getenv ("PLUMA_DEBUG_VIEW") != ((void*)0))
  debug = debug | PLUMA_DEBUG_VIEW;
 if (g_getenv ("PLUMA_DEBUG_SEARCH") != ((void*)0))
  debug = debug | PLUMA_DEBUG_SEARCH;
 if (g_getenv ("PLUMA_DEBUG_PREFS") != ((void*)0))
  debug = debug | PLUMA_DEBUG_PREFS;
 if (g_getenv ("PLUMA_DEBUG_PRINT") != ((void*)0))
  debug = debug | PLUMA_DEBUG_PRINT;
 if (g_getenv ("PLUMA_DEBUG_PLUGINS") != ((void*)0))
  debug = debug | PLUMA_DEBUG_PLUGINS;
 if (g_getenv ("PLUMA_DEBUG_TAB") != ((void*)0))
  debug = debug | PLUMA_DEBUG_TAB;
 if (g_getenv ("PLUMA_DEBUG_DOCUMENT") != ((void*)0))
  debug = debug | PLUMA_DEBUG_DOCUMENT;
 if (g_getenv ("PLUMA_DEBUG_COMMANDS") != ((void*)0))
  debug = debug | PLUMA_DEBUG_COMMANDS;
 if (g_getenv ("PLUMA_DEBUG_APP") != ((void*)0))
  debug = debug | PLUMA_DEBUG_APP;
 if (g_getenv ("PLUMA_DEBUG_SESSION") != ((void*)0))
  debug = debug | PLUMA_DEBUG_SESSION;
 if (g_getenv ("PLUMA_DEBUG_UTILS") != ((void*)0))
  debug = debug | PLUMA_DEBUG_UTILS;
 if (g_getenv ("PLUMA_DEBUG_METADATA") != ((void*)0))
  debug = debug | PLUMA_DEBUG_METADATA;
 if (g_getenv ("PLUMA_DEBUG_WINDOW") != ((void*)0))
  debug = debug | PLUMA_DEBUG_WINDOW;
 if (g_getenv ("PLUMA_DEBUG_LOADER") != ((void*)0))
  debug = debug | PLUMA_DEBUG_LOADER;
 if (g_getenv ("PLUMA_DEBUG_SAVER") != ((void*)0))
...
pluma_debug_message (PlumaDebugSection section,
       ...
       const gchar *format, ...)
{
 if ((__builtin_expect (__extension__ ({ int _g_boolean_var_8; if (debug & section) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 0)))
 {

  gdouble seconds;
  do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_9; if (timer != ((void*)0)) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "timer != NULL"); return; } } while (0);


  va_list args;
  gchar *msg;

  do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (format != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "format != NULL"); return; } } while (0);
  ...
  seconds = g_timer_elapsed (timer, ((void*)0));
  g_print ("[%f (%f)] %s:%d (%s) %s\n",
...
void pluma_debug (PlumaDebugSection section,
    ...
    const gchar *function)
{
 if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (debug & section) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 0)))
 {

  gdouble seconds;

  do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (timer != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "timer != NULL"); return; } } while (0);
