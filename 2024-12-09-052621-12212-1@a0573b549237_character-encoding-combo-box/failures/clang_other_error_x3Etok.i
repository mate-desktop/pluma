...
gchar* pluma_dirs_get_user_config_dir(void)
{
 gchar* config_dir = ((void*)0);

 config_dir = g_build_filename(g_get_user_config_dir(), "pluma", ((void*)0));
...
gchar* pluma_dirs_get_user_cache_dir(void)
{
 ...
 return g_build_filename(cache_dir, "pluma", ((void*)0));
}
...
gchar* pluma_dirs_get_user_plugins_dir(void)
{
 ...
 plugin_dir = g_build_filename(g_get_user_data_dir(), "pluma", "plugins", ((void*)0));
...
gchar* pluma_dirs_get_user_accels_file(void)
{
 ...
 accels = g_build_filename(config_dir, "accels", ((void*)0));
