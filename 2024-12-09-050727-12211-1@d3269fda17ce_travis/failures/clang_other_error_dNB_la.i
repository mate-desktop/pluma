...
# 2 "pluma-message.c" 2
# 1 "./pluma-message-type.h" 1




# 1 "/usr/bin/../lib/clang/19/include/stdarg.h" 1 3
# 6 "./pluma-message-type.h" 2
...
static void pluma_message_init (PlumaMessage *self); static void pluma_message_class_init (PlumaMessageClass *klass); static GType pluma_message_get_type_once (void); static gpointer pluma_message_parent_class = ((void*)0); static gint PlumaMessage_private_offset; static void pluma_message_class_intern_init (gpointer klass) { pluma_message_parent_class = g_type_class_peek_parent (klass); if (PlumaMessage_private_offset != 0) g_type_class_adjust_private_offset (klass, &PlumaMessage_private_offset); pluma_message_class_init ((PlumaMessageClass*) klass); } __attribute__ ((__unused__)) static inline gpointer pluma_message_get_instance_private (PlumaMessage *self) { return (((gpointer) ((guint8*) (self) + (glong) (PlumaMessage_private_offset)))); } GType pluma_message_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = pluma_message_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType pluma_message_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("PlumaMessage"), sizeof (PlumaMessageClass), (GClassInitFunc)(void (*)(void)) pluma_message_class_intern_init, sizeof (PlumaMessage), (GInstanceInitFunc)(void (*)(void)) pluma_message_init, (GTypeFlags) 0); { {{ PlumaMessage_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (PlumaMessagePrivate)); };} } return g_define_type_id; }

static void
pluma_message_finalize (GObject *object)
{
 PlumaMessage *message = ((((PlumaMessage*) (void *) ((object)))));

 pluma_message_type_unref (message->priv->type);
 g_hash_table_destroy (message->priv->values);

 ((((GObjectClass*) (void *) ((pluma_message_parent_class)))))->finalize (object);
}
...
pluma_message_get_property (GObject *object,
       ...
       GParamSpec *pspec)
{
 PlumaMessage *msg = ((((PlumaMessage*) (void *) ((object)))));
 ...
 switch (prop_id)
 {
  ...
  case PROP_TYPE:
   ...
   break;
  default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "pluma-message.c", 71, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
   break;
 }
}
       ...
       GParamSpec *pspec)
{
 ...
 {
  case PROP_TYPE:
   msg->priv->type = ((PlumaMessageType *)(g_value_dup_boxed (value)));
   break;
  default:
   do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((prop_id)); g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s:%d: invalid %s id %u for \"%s\" of type '%s' in '%s'", "pluma-message.c", 90, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
   break;
 }
}
    ...
    const gchar *key)
{
 ...
 value = (GValue *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (GValue); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 g_value_init (value, type);
 g_value_reset (value);

 g_hash_table_insert (message->priv->values, g_strdup_inline (key), value);
  ...
  const GValue *from)
{
 ...
 from_type = (((GValue*) (from))->g_type);
 to_type = (((GValue*) (to))->g_type);

 if (!((from_type) == (to_type) || (g_type_is_a) ((from_type), (to_type))))
 {
  if (!g_value_transform (from, to))
  {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s: Unable to make conversion from %s to %s", "pluma-message.c" ":" "200", g_type_name (from_type), g_type_name (to_type));
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return (((void*)0)); } } while (0);
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return (((void*)0)); } } while (0);
     ...
     va_list var_args)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);

 while ((key = __builtin_va_arg(var_args, const gchar *)) != ((void*)0))
 {

  GValue *container = value_lookup (message, key, (!(0)));
  GValue value = {0,};
  gchar *error = ((void*)0);

  if (!container)
  {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s: Cannot set value for %s, does not exist", "pluma-message.c" ":" "309", key);




   __builtin_va_arg(var_args, gpointer);
   continue;
  }

  g_value_init (&value, (((GValue*) (container))->g_type));
  do { GValue *g_vc_value = (&value); GType g_vc_value_type = (((GValue*) (g_vc_value))->g_type); GTypeValueTable *g_vc_vtable = g_type_value_table_peek (g_vc_value_type); if (g_vc_vtable->value_free) g_vc_vtable->value_free (g_vc_value); memset (g_vc_value->data, 0, sizeof (g_vc_value->data)); do { GTypeValueTable *g_vci_vtab; do { GValue *g_vci_val = (&value); guint g_vci_flags = (0); const gchar *g_vci_collect_format; GTypeCValue g_vci_cvalues[(8)] = { { 0, }, }; guint g_vci_n_values = 0; g_vci_vtab = g_type_value_table_peek (g_vc_value_type); g_vci_collect_format = g_vci_vtab->collect_format; g_vci_val->g_type = g_vc_value_type; while (*g_vci_collect_format) { GTypeCValue *g_vci_cvalue = g_vci_cvalues + g_vci_n_values++; switch (*g_vci_collect_format++) { case G_VALUE_COLLECT_INT: g_vci_cvalue->v_int = __builtin_va_arg((var_args), gint); break; case G_VALUE_COLLECT_LONG: g_vci_cvalue->v_long = __builtin_va_arg((var_args), glong); break; case G_VALUE_COLLECT_INT64: g_vci_cvalue->v_int64 = __builtin_va_arg((var_args), gint64); break; case G_VALUE_COLLECT_DOUBLE: g_vci_cvalue->v_double = __builtin_va_arg((var_args), gdouble); break; case G_VALUE_COLLECT_POINTER: g_vci_cvalue->v_pointer = __builtin_va_arg((var_args), gpointer); break; default: do { g_assertion_message_expr (((gchar*) 0), "pluma-message.c", 318, ((const char*) (__func__)), ((void*)0)); } while (0); } } *(&error) = g_vci_vtab->collect_value (g_vci_val, g_vci_n_values, g_vci_cvalues, g_vci_flags); } while (0); } while (0); } while (0);

  if (error)
  {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s: %s", "pluma-message.c" ":" "322", error);
   continue;
  }
...
{
 GValue *container;
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);

 container = value_lookup (message, key, (!(0)));

 if (!container)
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s: Cannot set value for %s, does not exist", "pluma-message.c" ":" "353", key);
      ...
      gint n_values)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);
     ...
     ...)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);
     ...
     va_list var_args)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);
    ...
    GValue *value)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_18; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_18 = 1; else _g_boolean_var_18 = 0; _g_boolean_var_18; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);

 container = value_lookup (message, key, (0));

 if (!container)
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "%s: Invalid key `%s'", "pluma-message.c" ":" "488", key);
...
pluma_message_get_key_type (PlumaMessage *message,
       const gchar *key)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_19; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_19 = 1; else _g_boolean_var_19 = 0; _g_boolean_var_19; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return (((GType) ((0) << (2)))); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_20; if (message->priv->type != ((void*)0)) _g_boolean_var_20 = 1; else _g_boolean_var_20 = 0; _g_boolean_var_20; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message->priv->type != NULL"); return (((GType) ((0) << (2)))); } } while (0);
...
pluma_message_has_key (PlumaMessage *message,
         const gchar *key)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_21; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_21 = 1; else _g_boolean_var_21 = 0; _g_boolean_var_21; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return ((0)); } } while (0);

 return value_lookup (message, key, (0)) != ((void*)0);
}
       ...
       ValidateInfo *info)
{
 ...
 value = value_lookup (info->message, key, (0));
...
{
 ValidateInfo info = {message, (!(0))};

 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_22; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_22 = 1; else _g_boolean_var_22 = 0; _g_boolean_var_22; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return ((0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_23; if (message->priv->type != ((void*)0)) _g_boolean_var_23 = 1; else _g_boolean_var_23 = 0; _g_boolean_var_23; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message->priv->type != NULL"); return ((0)); } } while (0);
