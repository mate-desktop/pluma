# 1 "bacon-message-connection.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "bacon-message-connection.c" 2
# 21 "bacon-message-connection.c"
...
# 22 "bacon-message-connection.c" 2
...
# 23 "bacon-message-connection.c" 2
...
# 24 "bacon-message-connection.c" 2
...
# 25 "bacon-message-connection.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 26 "bacon-message-connection.c" 2
...
# 27 "bacon-message-connection.c" 2
...
# 29 "bacon-message-connection.c" 2
...
# 30 "bacon-message-connection.c" 2
...
# 31 "bacon-message-connection.c" 2

# 1 "./bacon-message-connection.h" 1
# 24 "./bacon-message-connection.h"
...
# 25 "./bacon-message-connection.h" 2
...
# 33 "bacon-message-connection.c" 2
...
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_8; if (conn->chan == ((void*)0)) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn->chan == NULL"); return ((0)); } } while (0);
...
accept_new_connection (BaconMessageConnection *server_conn)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_9; if (server_conn->is_server) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "server_conn->is_server"); return; } } while (0);

 conn = (BaconMessageConnection *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (BaconMessageConnection); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 conn->is_server = (0);
 conn->func = server_conn->func;
 conn->data = server_conn->data;

 conn->fd = accept (server_conn->fd, ((void*)0), (guint *)&alen);
...
server_cb (GIOChannel *source, GIOCondition condition, gpointer data)
{
 ...
 if (rc <= 0) {
  g_io_channel_shutdown (conn->chan, (0), ((void*)0));
...
find_file_with_pattern (const char *dir, const char *pattern)
{
 ...
 filedir = g_dir_open (dir, 0, ((void*)0));
 if (filedir == ((void*)0))
  return ((void*)0);
 ...
 found_filename = ((void*)0);

 while ((filename = g_dir_read_name (filedir)))
 {
  if (g_pattern_match_string (pat, filename))
  {
   char *tmp = g_build_filename (dir, filename, ((void*)0));
   if (is_owned_by_user_and_socket (tmp))
    found_filename = g_strdup_inline (filename);
   g_free (tmp);
  }

  if (found_filename != ((void*)0))
   break;
 }
...
socket_filename (const char *prefix)
{
 ...
 if (filename == ((void*)0))
 {
  ...
  path = g_build_filename (tmpdir, newfile, ((void*)0));
  g_free (newfile);
 } else {
  path = g_build_filename (tmpdir, filename, ((void*)0));
  g_free (filename);
 }
...
try_server (BaconMessageConnection *conn)
{
 ...
 strncpy (uaddr.sun_path, conn->path,
   (((strlen(conn->path)+1) < (108)) ? (strlen(conn->path)+1) : (108)));
 conn->fd = socket (1, SOCK_STREAM, 0);
...
bacon_message_connection_new (const char *prefix)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (prefix != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "prefix != NULL"); return (((void*)0)); } } while (0);

 conn = (BaconMessageConnection *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (BaconMessageConnection); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 conn->path = socket_filename (prefix);

 if (test_is_socket (conn->path) == (0))
 {
  if (!try_server (conn))
  {
...
bacon_message_connection_free (BaconMessageConnection *conn)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (conn != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn != NULL"); return; } } while (0);

 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (conn->is_server != (0) || conn->accepted_connections == ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn->is_server != FALSE || conn->accepted_connections == NULL"); return; } } while (0);


 child_conn = conn->accepted_connections;
 while (child_conn != ((void*)0)) {
  bacon_message_connection_free (child_conn->data);
  child_conn = ((child_conn) ? (((GSList *)(child_conn))->next) : ((void*)0));
 }
...
bacon_message_connection_set_callback (BaconMessageConnection *conn,
           ...
           gpointer user_data)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (conn != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn != NULL"); return; } } while (0);
...
bacon_message_connection_send (BaconMessageConnection *conn,
          const char *message)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (conn != ((void*)0)) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn != NULL"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (message != ((void*)0)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message != NULL"); return; } } while (0);

 g_io_channel_write_chars (conn->chan, message, strlen (message),
      ((void*)0), ((void*)0));
 g_io_channel_write_chars (conn->chan, "\n", 1, ((void*)0), ((void*)0));
 g_io_channel_flush (conn->chan, ((void*)0));
}

gboolean
bacon_message_connection_get_is_server (BaconMessageConnection *conn)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if (conn != ((void*)0)) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "conn != NULL"); return ((0)); } } while (0);
