# 1 "pluma-message-type.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "pluma-message-type.c" 2
...
void pluma_message_type_foreach (PlumaMessageType *message_type,
        ...
        gpointer user_data);
# 2 "pluma-message-type.c" 2
# 37 "pluma-message-type.c"
typedef struct
{
 GType type;
 gboolean required;
...
# 66 "pluma-message-type.c"
PlumaMessageType *
pluma_message_type_ref (PlumaMessageType *message_type)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (message_type != ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message_type != NULL"); return (((void*)0)); } } while (0);
 (__extension__ ({ _Static_assert (sizeof *(&message_type->ref_count) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&message_type->ref_count) ^ *(&message_type->ref_count) : 1); (void) __atomic_fetch_add ((&message_type->ref_count), 1, 5); }));

 return message_type;
}
# 83 "pluma-message-type.c"
void
pluma_message_type_unref (PlumaMessageType *message_type)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (message_type != ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message_type != NULL"); return; } } while (0);

 if (!(__extension__ ({ _Static_assert (sizeof *(&message_type->ref_count) == sizeof (gint), "Expression evaluates to false"); (void) (0 ? *(&message_type->ref_count) ^ *(&message_type->ref_count) : 1); __atomic_fetch_sub ((&message_type->ref_count), 1, 5) == 1; })))
  return;
...
# 130 "pluma-message-type.c"
gchar *
pluma_message_type_identifier (const gchar *object_path,
          const gchar *method)
{
 return g_strconcat (object_path, ".", method, ((void*)0));
}
# 146 "pluma-message-type.c"
gboolean
pluma_message_type_is_valid_object_path (const gchar *object_path)
{
 ...
 while (*object_path)
 {
  if (*object_path == '/')
  {
   ...
   if (!*object_path || !(((g_ascii_table[(guchar) (*object_path)] & G_ASCII_ALPHA) != 0) || *object_path == '_'))
    return (0);
  }
  else if (!(((g_ascii_table[(guchar) (*object_path)] & G_ASCII_ALNUM) != 0) || *object_path == '_'))
  {
   return (0);
  }
...
pluma_message_type_is_supported (GType type)
{
 ...
 if (!(g_type_check_is_value_type (type)))
  return (0);

 while (type_list[i] != ((GType) ((0) << (2))))
 {
  if (((type) == (type_list[i]) || (g_type_is_a) ((type), (type_list[i]))))
   return (!(0));
  i++;
 }
          ...
          va_list var_args)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if (pluma_message_type_is_valid_object_path (object_path)) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "pluma_message_type_is_valid_object_path (object_path)"); return (((void*)0)); } } while (0);

 message_type = (PlumaMessageType *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (PlumaMessageType); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));

 message_type->ref_count = 1;
 message_type->object_path = g_strdup_inline (object_path);
 message_type->method = g_strdup_inline (method);
...
{
 const gchar *key;
 ArgumentInfo **optional = (ArgumentInfo * *) (__extension__ ({ gsize __n = (gsize) (num_optional); gsize __s = sizeof (ArgumentInfo *); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));
 guint i;
 guint added = 0;
 ...
 while ((key = __builtin_va_arg(var_args, const gchar *)) != ((void*)0))
 {
  ...
  GType gtype = __builtin_va_arg(var_args, GType);
  ArgumentInfo *info;

  if (!pluma_message_type_is_supported (gtype))
  {
   do { g_log (((gchar*) 0), G_LOG_LEVEL_ERROR, "Message type '%s' is not supported", g_type_name (gtype)); for (;;) ; } while (0);
  ...
  info = (ArgumentInfo *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (ArgumentInfo); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
  info->type = gtype;
  info->required = (!(0));

  g_hash_table_insert (message_type->arguments, g_strdup_inline (key), info);
           ...
           va_list va_args)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (message_type != ((void*)0)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "message_type != NULL"); return (((void*)0)); } } while (0);

 message = ((((PlumaMessage*) (void *) ((g_object_new ((pluma_message_get_type ()), "type", message_type, ((void*)0)))))));
 pluma_message_set_valist (message, va_args);

 return message;
}
# 426 "pluma-message-type.c"
PlumaMessage *
