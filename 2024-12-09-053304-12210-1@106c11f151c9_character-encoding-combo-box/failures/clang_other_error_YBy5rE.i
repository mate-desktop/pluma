# 1 "pluma-taglist-plugin-parser.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "pluma-taglist-plugin-parser.c" 2
# 35 "pluma-taglist-plugin-parser.c"
# 1 "../../config.h" 1
# 36 "pluma-taglist-plugin-parser.c" 2
...
extern size_t strlcat (char *__restrict __dest,
         const char *__restrict __src, size_t __n)
  __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2))) ;
# 39 "pluma-taglist-plugin-parser.c" 2
...
# 40 "pluma-taglist-plugin-parser.c" 2
...
# 41 "pluma-taglist-plugin-parser.c" 2
...
# 42 "pluma-taglist-plugin-parser.c" 2
...
# 44 "pluma-taglist-plugin-parser.c" 2

# 1 "./pluma-taglist-plugin-parser.h" 1
# 35 "./pluma-taglist-plugin-parser.h"
# 1 "/usr/include/libxml2/libxml/tree.h" 1
# 36 "./pluma-taglist-plugin-parser.h" 2
...
# 46 "pluma-taglist-plugin-parser.c" 2



TagList* taglist = ((void*)0);
...
parse_tag (Tag *tag, xmlDocPtr doc, xmlNsPtr ns, xmlNodePtr cur)
{
 ...
 while (cur != ((void*)0))
 {
  if ((!xmlStrcmp (cur->name, (const xmlChar *)"Begin")) &&
      (cur->ns == ns))
  {
   tag->begin = xmlNodeListGetString (doc, cur->children, 1);
  ...
  if ((!xmlStrcmp (cur->name, (const xmlChar *)"End")) &&
      (cur->ns == ns))
  {
   tag->end = xmlNodeListGetString (doc, cur->children, 1);
 ...
 if ((tag->begin == ((void*)0)) && (tag->end == ((void*)0)))
  return (0);
...
{
 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 117, ((const char*) (__func__)), "Parse TagGroup: %s", tg->name);
 ...
 while (cur != ((void*)0))
 {
  ...
  {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "was '%s', 'Tag' expected.", fn, cur->name);
  ...
  else
  {
   ...
   tag = (Tag *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (Tag); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));


   tag->name = (xmlChar*)dcgettext (((void*)0), (const char*)xmlGetProp (cur, (const xmlChar *) "name"), 5);

   if (tag->name == ((void*)0))
   {

    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "Tag without name.", fn);
   ...
   else
   {
    ...
    else
    {
     ...
     g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "error parsing Tag '%s' in TagGroup '%s'.", fn, tag->name, tg->name);
   ...
   xmlNsPtr ns, xmlNodePtr cur)
{
 ...
 tag_group = (TagGroup *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (TagGroup); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));


 tag_group->name = (xmlChar*)dcgettext (((void*)0), (const char*)xmlGetProp (cur, (const xmlChar *) "name"), 5);
 ...
 if (tag_group->name == ((void*)0))
 {

  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "TagGroup without name.", filename);
 ...
 else
 {
  ...
  while (t && !exists)
  {
   ...
   {
    pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 234, ((const char*) (__func__)),
  ...
  if (!exists)
  {
   ...
   else
   {
    ...
    g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "error parsing TagGroup '%s'.", filename, tag_group->name);
...
# 290 "pluma-taglist-plugin-parser.c"
static TagList*
                  ...
                  xmlNodePtr cur)
{
 ...
 TagGroup *best_tag_group = ((void*)0);
 TagGroup *tag_group;
 gint best_lanking = -1;
 ...
 while (cur != ((void*)0))
  ...
  {
   g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "was '%s', 'TagGroup' expected.", filename, cur->name);
  ...
  else
  {
   ...
   for (i = 0; langs_pointer[i] != ((void*)0); i++)
   {
    const gchar *best_lang = langs_pointer[i];
# 367 "pluma-taglist-plugin-parser.c"
    if (lang == ((void*)0) &&
...
parse_taglist_file (const gchar* filename)
{
 ...
 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 429, ((const char*) (__func__)), "Parse file: %s", filename);
 ...
 if (doc == ((void*)0))
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is empty.", filename);
 ...
 if (ns == ((void*)0))
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "pluma namespace not found.", filename);
 ...
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "The tag list file '%s' is of the wrong type, " "root node != TagList.", filename);
 ...
 if (taglist == ((void*)0))
  taglist = (TagList *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (TagList); gpointer __p; if (__s == 1) __p = g_malloc0 (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc0 (__n * __s); else __p = g_malloc0_n (__n, __s); __p; }));

 taglist = lookup_best_lang (taglist, filename, doc, ns, cur);

 xmlFreeDoc (doc);

 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 489, ((const char*) (__func__)), "END");
...
free_tag (Tag *tag)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_8; if (tag != ((void*)0)) _g_boolean_var_8 = 1; else _g_boolean_var_8 = 0; _g_boolean_var_8; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "tag != NULL"); return; } } while (0);
...
free_tag_group (TagGroup *tag_group)
{
 ...
 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 518, ((const char*) (__func__)), "Tag group: %s", tag_group->name);

 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_9; if (tag_group != ((void*)0)) _g_boolean_var_9 = 1; else _g_boolean_var_9 = 0; _g_boolean_var_9; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "tag_group != NULL"); return; } } while (0);

 free (tag_group->name);

 for (l = tag_group->tags; l != ((void*)0); l = ((l) ? (((GList *)(l))->next) : ((void*)0)))
 {
  free_tag ((Tag *) l->data);
 }
 ...
 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 532, ((const char*) (__func__)), "END");
}
...
void free_taglist(void)
{
 ...
 pluma_debug_message(PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 539, ((const char*) (__func__)), "ref_count: %d", taglist_ref_count);
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (taglist_ref_count > 0) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "taglist_ref_count > 0"); return; } } while (0);
 ...
 for (l = taglist->tag_groups; l != ((void*)0); l = ((l) ? (((GList *)(l))->next) : ((void*)0)))
 {
 ...
 pluma_debug_message (PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 564, ((const char*) (__func__)), "Really freed");
}
...
static TagList* parse_taglist_dir(const gchar* dir)
{
 ...
 pluma_debug_message(PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 573, ((const char*) (__func__)), "DIR: %s", dir);

 d = g_dir_open(dir, 0, &error);

 if (!d)
 {
  pluma_debug_message(PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 579, ((const char*) (__func__)), "%s", error->message);
  g_error_free (error);
  return taglist;
 }
 ...
 {
  if ((__builtin_constant_p (".tags")? __extension__ ({ const char * const __str = (dirent); const char * const __suffix = (".tags"); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_11; if (__str == ((void*)0) || __suffix == ((void*)0)) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 0)) __result = (g_str_has_suffix) (__str, __suffix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __suffix_len = strlen (((__suffix) + !(__suffix))); if (__str_len >= __suffix_len) __result = memcmp (__str + __str_len - __suffix_len, ((__suffix) + !(__suffix)), __suffix_len) == 0; } __result; }) : (g_str_has_suffix) (dirent, ".tags") ) || (__builtin_constant_p (".tags.gz")? __extension__ ({ const char * const __str = (dirent); const char * const __suffix = (".tags.gz"); gboolean __result = (0); if (__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (__str == ((void*)0) || __suffix == ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 0)) __result = (g_str_has_suffix) (__str, __suffix); else { const size_t __str_len = strlen (((__str) + !(__str))); const size_t __suffix_len = strlen (((__suffix) + !(__suffix))); if (__str_len >= __suffix_len) __result = memcmp (__str + __str_len - __suffix_len, ((__suffix) + !(__suffix)), __suffix_len) == 0; } __result; }) : (g_str_has_suffix) (dirent, ".tags.gz") ))
  {
   gchar* tags_file = g_build_filename(dir, dirent, ((void*)0));
...
TagList* create_taglist(const gchar* data_dir)
{
 ...
 pluma_debug_message(PLUMA_DEBUG_PLUGINS, "pluma-taglist-plugin-parser.c", 603, ((const char*) (__func__)), "ref_count: %d", taglist_ref_count);
 ...
 if (home != ((void*)0))
 {
  pdir = g_build_filename(home, ".config", "pluma/taglist/", ((void*)0));
 ...
 ++taglist_ref_count;
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (taglist_ref_count == 1) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "taglist_ref_count == 1"); return (taglist); } } while (0);
