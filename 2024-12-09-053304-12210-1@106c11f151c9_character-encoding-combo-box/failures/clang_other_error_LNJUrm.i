# 1 "pluma-message-bus.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 398 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "pluma-message-bus.c" 2
# 1 "./pluma-message-bus.h" 1
...
# 5 "./pluma-message-bus.h" 2
# 1 "../pluma/pluma-message.h" 1




# 1 "/usr/bin/../lib/clang/19/include/stdarg.h" 1 3
# 6 "../pluma/pluma-message.h" 2
# 17 "../pluma/pluma-message.h"
...
GType pluma_message_get_type (void) __attribute__ ((__const__));
...
# 6 "./pluma-message-bus.h" 2
# 1 "../pluma/pluma-message-type.h" 1




# 1 "/usr/bin/../lib/clang/19/include/stdarg.h" 1 3
# 6 "../pluma/pluma-message-type.h" 2
...
GType pluma_message_type_get_type (void) __attribute__ ((__const__));
...
void pluma_message_type_foreach (PlumaMessageType *message_type,
        ...
        gpointer user_data);
# 7 "./pluma-message-bus.h" 2
# 18 "./pluma-message-bus.h"
...
GType pluma_message_bus_get_type (void) __attribute__ ((__const__));
...
PlumaMessage *pluma_message_bus_send_sync (PlumaMessageBus *bus,
        ...
        const gchar *method,
        ...) __attribute__((__sentinel__));
# 2 "pluma-message-bus.c" 2


# 1 "/usr/bin/../lib/clang/19/include/stdarg.h" 1 3
# 5 "pluma-message-bus.c" 2
...
# 56 "/usr/include/glib-2.0/gobject/gvaluecollector.h"
union _GTypeCValue
{
  gint v_int;
  glong v_long;
...
# 6 "pluma-message-bus.c" 2
# 93 "pluma-message-bus.c"
typedef struct
{
 gchar *object_path;
 gchar *method;
...
static void pluma_message_bus_init (PlumaMessageBus *self); static void pluma_message_bus_class_init (PlumaMessageBusClass *klass); static GType pluma_message_bus_get_type_once (void); static gpointer pluma_message_bus_parent_class = ((void*)0); static gint PlumaMessageBus_private_offset; static void pluma_message_bus_class_intern_init (gpointer klass) { pluma_message_bus_parent_class = g_type_class_peek_parent (klass); if (PlumaMessageBus_private_offset != 0) g_type_class_adjust_private_offset (klass, &PlumaMessageBus_private_offset); pluma_message_bus_class_init ((PlumaMessageBusClass*) klass); } __attribute__ ((__unused__)) static inline gpointer pluma_message_bus_get_instance_private (PlumaMessageBus *self) { return (((gpointer) ((guint8*) (self) + (glong) (PlumaMessageBus_private_offset)))); } GType pluma_message_bus_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = pluma_message_bus_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType pluma_message_bus_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("PlumaMessageBus"), sizeof (PlumaMessageBusClass), (GClassInitFunc)(void (*)(void)) pluma_message_bus_class_intern_init, sizeof (PlumaMessageBus), (GInstanceInitFunc)(void (*)(void)) pluma_message_bus_init, (GTypeFlags) 0); { {{ PlumaMessageBus_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (PlumaMessageBusPrivate)); };} } return g_define_type_id; }
...
{
 PlumaMessageBus *bus = ((((PlumaMessageBus*) (void *) ((object)))));
 ...
 ((((GObjectClass*) (void *) ((pluma_message_bus_parent_class)))))->finalize (object);
}
...
# 203 "pluma-message-bus.c"
 message_bus_signals[DISPATCH] =
     g_signal_new ("dispatch",
         ((((GTypeClass*) (object_class))->g_type)),
         G_SIGNAL_RUN_LAST,
         ((glong) __builtin_offsetof(PlumaMessageBusClass, dispatch)),
         ((void*)0), ((void*)0), ((void*)0),
         ((GType) ((1) << (2))),
         1,
         (pluma_message_get_type ()));
# 222 "pluma-message-bus.c"
 message_bus_signals[REGISTERED] =
     g_signal_new ("registered",
         ((((GTypeClass*) (object_class))->g_type)),
         G_SIGNAL_RUN_LAST,
         ((glong) __builtin_offsetof(PlumaMessageBusClass, registered)),
         ((void*)0), ((void*)0), ((void*)0),
         ((GType) ((1) << (2))),
         1,
         (pluma_message_type_get_type ()));
# 241 "pluma-message-bus.c"
 message_bus_signals[UNREGISTERED] =
     g_signal_new ("unregistered",
         ((((GTypeClass*) (object_class))->g_type)),
         G_SIGNAL_RUN_LAST,
         ((glong) __builtin_offsetof(PlumaMessageBusClass, unregistered)),
         ((void*)0), ((void*)0), ((void*)0),
         ((GType) ((1) << (2))),
         1,
         (pluma_message_type_get_type ()));
...
message_new (PlumaMessageBus *bus,
      ...
      const gchar *method)
{
 Message *message = (Message *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (Message); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));

 message->object_path = g_strdup_inline (object_path);
 message->method = g_strdup_inline (method);
 message->listeners = ((void*)0);
       ...
       GDestroyNotify destroy_data)
{
 ...
 listener = (Listener *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (Listener); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
 ...
 idmap = (IdMap *) (__extension__ ({ gsize __n = (gsize) (1); gsize __s = sizeof (IdMap); gpointer __p; if (__s == 1) __p = g_malloc (__n); else if (__builtin_constant_p (__n) && (__s == 0 || __n <= (9223372036854775807L *2UL+1UL) / __s)) __p = g_malloc (__n * __s); else __p = g_malloc_n (__n, __s); __p; }));
 idmap->message = message;
 idmap->listener = g_list_last (message->listeners);

 g_hash_table_insert (bus->priv->idmap, ((gpointer) (glong) (listener->id)), idmap);
 return listener->id;
}
   ...
   GList *listener)
{
 ...
 g_hash_table_remove (bus->priv->idmap, ((gpointer) (glong) (lst->id)));
 listener_free (lst);
     ...
     PlumaMessage *message)
{
 ...
 msg = lookup_message (bus, object_path, method, (0));
...
idle_dispatch (PlumaMessageBus *bus)
{
 ...
 bus->priv->message_queue = ((void*)0);

 for (item = list; item; item = item->next)
 {
  PlumaMessage *msg = ((((PlumaMessage*) (void *) ((item->data)))));
        ...
        MatchCallback processor)
{
 ...
 idmap = (IdMap *)g_hash_table_lookup (bus->priv->idmap, ((gpointer) (glong) (id)));

 if (idmap == ((void*)0))
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "No handler registered with id `%d'", id);
  return;
 }
           ...
           MatchCallback processor)
{
 ...
 message = lookup_message (bus, object_path, method, (0));

 if (!message)
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "No such handler registered for %s.%s", object_path, method);
  return;
 }
...
# 511 "pluma-message-bus.c"
PlumaMessageBus *
pluma_message_bus_get_default (void)
{
 static PlumaMessageBus *default_bus = ((void*)0);

 if ((__builtin_expect (__extension__ ({ int _g_boolean_var_10; if (default_bus == ((void*)0)) _g_boolean_var_10 = 1; else _g_boolean_var_10 = 0; _g_boolean_var_10; }), 0)))
 {
  default_bus = g_object_new ((pluma_message_bus_get_type ()), ((void*)0));
  g_object_add_weak_pointer (((((GObject*) (void *) ((default_bus))))),
               (gpointer) &default_bus);
 }

 return default_bus;
}
# 536 "pluma-message-bus.c"
PlumaMessageBus *
pluma_message_bus_new (void)
{
 return ((((PlumaMessageBus*) (void *) ((g_object_new ((pluma_message_bus_get_type ()), ((void*)0)))))));
}
# 555 "pluma-message-bus.c"
PlumaMessageType *
     ...
     const gchar *method)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_11; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_11 = 1; else _g_boolean_var_11 = 0; _g_boolean_var_11; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_12; if (object_path != ((void*)0)) _g_boolean_var_12 = 1; else _g_boolean_var_12 = 0; _g_boolean_var_12; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "object_path != NULL"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_13; if (method != ((void*)0)) _g_boolean_var_13 = 1; else _g_boolean_var_13 = 0; _g_boolean_var_13; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "method != NULL"); return (((void*)0)); } } while (0);

 identifier = pluma_message_type_identifier (object_path, method);
 message_type = ((PlumaMessageType *)(g_hash_table_lookup (bus->priv->types, identifier)));

 g_free (identifier);
 return message_type;
}
# 596 "pluma-message-bus.c"
PlumaMessageType *
       ...
       ...)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_14; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_14 = 1; else _g_boolean_var_14 = 0; _g_boolean_var_14; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return (((void*)0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_15; if (pluma_message_type_is_valid_object_path (object_path)) _g_boolean_var_15 = 1; else _g_boolean_var_15 = 0; _g_boolean_var_15; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "pluma_message_type_is_valid_object_path (object_path)"); return (((void*)0)); } } while (0);

 if (pluma_message_bus_is_registered (bus, object_path, method))
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Message type for '%s.%s' is already registered", object_path, method);
  return ((void*)0);
 }
 ...
 __builtin_va_start(var_args, num_optional);
       ...
       gboolean remove_from_store)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_16; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_16 = 1; else _g_boolean_var_16 = 0; _g_boolean_var_16; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
...
# 672 "pluma-message-bus.c"
void
pluma_message_bus_unregister (PlumaMessageBus *bus,
         PlumaMessageType *message_type)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_17; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_17 = 1; else _g_boolean_var_17 = 0; _g_boolean_var_17; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
 pluma_message_bus_unregister_real (bus, message_type, (!(0)));
}
   ...
   UnregisterInfo *info)
{
 if (strcmp (pluma_message_type_get_object_path (message_type),
      info->object_path) == 0)
 {
  pluma_message_bus_unregister_real (info->bus, message_type, (0));
  return (!(0));
 }

 return (0);
}
# 713 "pluma-message-bus.c"
void
             ...
             const gchar *object_path)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_18; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_18 = 1; else _g_boolean_var_18 = 0; _g_boolean_var_18; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_19; if (object_path != ((void*)0)) _g_boolean_var_19 = 1; else _g_boolean_var_19 = 0; _g_boolean_var_19; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "object_path != NULL"); return; } } while (0);

 g_hash_table_foreach_remove (bus->priv->types,
         (GHRFunc)unregister_each,
         &info);
}
# 740 "pluma-message-bus.c"
gboolean
     ...
     const gchar *method)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_20; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_20 = 1; else _g_boolean_var_20 = 0; _g_boolean_var_20; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return ((0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_21; if (object_path != ((void*)0)) _g_boolean_var_21 = 1; else _g_boolean_var_21 = 0; _g_boolean_var_21; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "object_path != NULL"); return ((0)); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_22; if (method != ((void*)0)) _g_boolean_var_22 = 1; else _g_boolean_var_22 = 0; _g_boolean_var_22; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "method != NULL"); return ((0)); } } while (0);

 identifier = pluma_message_type_identifier (object_path, method);
 ret = g_hash_table_lookup (bus->priv->types, identifier) != ((void*)0);
      ...
      gpointer userdata)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_23; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_23 = 1; else _g_boolean_var_23 = 0; _g_boolean_var_23; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_24; if (func != ((void*)0)) _g_boolean_var_24 = 1; else _g_boolean_var_24 = 0; _g_boolean_var_24; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "func != NULL"); return; } } while (0);

 g_hash_table_foreach (bus->priv->types, (GHFunc)foreach_type, &info);
}
# 813 "pluma-message-bus.c"
guint
             ...
             GDestroyNotify destroy_data)
{
 ...
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_25; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_25 = 1; else _g_boolean_var_25 = 0; _g_boolean_var_25; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return (0); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_26; if (object_path != ((void*)0)) _g_boolean_var_26 = 1; else _g_boolean_var_26 = 0; _g_boolean_var_26; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "object_path != NULL"); return (0); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_27; if (method != ((void*)0)) _g_boolean_var_27 = 1; else _g_boolean_var_27 = 0; _g_boolean_var_27; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "method != NULL"); return (0); } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_28; if (callback != ((void*)0)) _g_boolean_var_28 = 1; else _g_boolean_var_28 = 0; _g_boolean_var_28; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "callback != NULL"); return (0); } } while (0);
...
# 842 "pluma-message-bus.c"
void
pluma_message_bus_disconnect (PlumaMessageBus *bus,
         guint id)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_29; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_29 = 1; else _g_boolean_var_29 = 0; _g_boolean_var_29; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);

 process_by_id (bus, id, remove_listener);
}
# 864 "pluma-message-bus.c"
void
pluma_message_bus_disconnect_by_func (PlumaMessageBus *bus,
          ...
          gpointer userdata)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_30; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_30 = 1; else _g_boolean_var_30 = 0; _g_boolean_var_30; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);

 process_by_match (bus, object_path, method, callback, userdata, remove_listener);
}
# 885 "pluma-message-bus.c"
void
pluma_message_bus_block (PlumaMessageBus *bus,
    guint id)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_31; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_31 = 1; else _g_boolean_var_31 = 0; _g_boolean_var_31; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);

 process_by_id (bus, id, block_listener);
}
# 906 "pluma-message-bus.c"
void
pluma_message_bus_block_by_func (PlumaMessageBus *bus,
     ...
     gpointer userdata)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_32; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_32 = 1; else _g_boolean_var_32 = 0; _g_boolean_var_32; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);

 process_by_match (bus, object_path, method, callback, userdata, block_listener);
}
# 926 "pluma-message-bus.c"
void
pluma_message_bus_unblock (PlumaMessageBus *bus,
      guint id)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_33; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_33 = 1; else _g_boolean_var_33 = 0; _g_boolean_var_33; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);

 process_by_id (bus, id, unblock_listener);
}
# 946 "pluma-message-bus.c"
void
pluma_message_bus_unblock_by_func (PlumaMessageBus *bus,
       ...
       gpointer userdata)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_34; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_34 = 1; else _g_boolean_var_34 = 0; _g_boolean_var_34; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
...
validate_message (PlumaMessage *message)
{
 ...
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Message '%s.%s' is invalid", pluma_message_get_object_path (message), pluma_message_get_method (message));
     ...
     PlumaMessage *message)
{
 ...
 bus->priv->message_queue = g_list_prepend (bus->priv->message_queue,
         ((__typeof__ (message)) (g_object_ref) (message)));

 if (bus->priv->idle_id == 0)
  bus->priv->idle_id = g_idle_add_full (-100,
            (GSourceFunc)idle_dispatch,
            bus,
            ((void*)0));
}
# 1001 "pluma-message-bus.c"
void
pluma_message_bus_send_message (PlumaMessageBus *bus,
           PlumaMessage *message)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_35; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_35 = 1; else _g_boolean_var_35 = 0; _g_boolean_var_35; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_36; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_36 = 1; else _g_boolean_var_36 = 0; _g_boolean_var_36; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);
...
# 1034 "pluma-message-bus.c"
void
pluma_message_bus_send_message_sync (PlumaMessageBus *bus,
                PlumaMessage *message)
{
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_37; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((bus)); GType __t = ((pluma_message_bus_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_37 = 1; else _g_boolean_var_37 = 0; _g_boolean_var_37; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE_BUS (bus)"); return; } } while (0);
 do { if ((__builtin_expect (__extension__ ({ int _g_boolean_var_38; if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((message)); GType __t = ((pluma_message_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) _g_boolean_var_38 = 1; else _g_boolean_var_38 = 0; _g_boolean_var_38; }), 1))) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "PLUMA_IS_MESSAGE (message)"); return; } } while (0);
  ...
  va_list var_args)
{
 ...
 if (!message_type)
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Could not find message type for '%s.%s'", object_path, method);
  return ((void*)0);
 }
   ...
   ...)
{
 ...
 __builtin_va_start(var_args, method);
 ...
 {
  g_log (((gchar*) 0), G_LOG_LEVEL_WARNING, "Could not instantiate message");
 }

 __builtin_va_end(var_args);
}
# 1119 "pluma-message-bus.c"
PlumaMessage *
